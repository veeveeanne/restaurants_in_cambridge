...
Review.create(overall: 2, food: 5, service: 1, price: 4, body: "Food was great but service was awful", restaurant: restaurant1)
Review.create(overall: 5, food: 5, service: 5, price: 4, ambience: 4, body: "The food and service were all wonderful. Loved the ambience too!", restaurant: restaurant1)
Review.create(overall: 4, food: 4, service: 3, price: 3, body: "Great burgers here. Came here for a dinner with friends and had a great time.", restaurant: restaurant2)